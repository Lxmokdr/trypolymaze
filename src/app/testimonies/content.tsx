...
export default function Content() {
  return (
    <div id="testimonies" className="w-full min-h-screen relative bg-[#000000] lg:mt-40">
      ...
      <div className="flex flex-row items-start pb-15"></div>
        <div className="flex flex-row items-start mb-10">
          ...
          <h1 className="text-3xl md:text-5xl text-white font-bold font">Testimonies</h1>
          </div>
        </div>
