      ...
      <div className="absolute inset-0 w-full h-full">
        ...
        <div className="absolute inset-0 z-10 flex flex-col items-start justify-start gap-6 px-4 text-center top-45 pl-20 lg:w-9/10 left-1/20">
          ...
          <div className="flex justify-between gap-4 w-full">
            <div className="flex flex-col items-center w-full">
              ...
              <a
                ...
                download
                className="bg-black text-white py-4 px-10 rounded-xl border border-white text-xl m-5"
              >
                Download PDF
              </a>
            </div>
          ...
          <a
                href=""
                download
                className="bg-white text-black py-4 px-10 rounded-xl text-xl m-5 justify-center"
              >
                Register Now
              </a>
          </div>
